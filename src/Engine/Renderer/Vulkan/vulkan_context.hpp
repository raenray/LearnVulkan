...
namespace Engine { namespace Renderer {
    class VulkanDevice; class VulkanSwapchain;
    struct VulkanQueue;
...
#include <functional>
namespace Engine { namespace Renderer {
struct VulkanContextConfig { const char* appName="LearnVulkan"; bool enableValidation=true; uint32_t apiMajor=1,apiMinor=0; };
class VulkanContext {
public:
...
private:
    ...
    VkInstance inst_=VK_NULL_HANDLE; VkSurfaceKHR surf_=VK_NULL_HANDLE;
};
} }
