...
constexpr ShaderHandle kInvalidShader = UINT32_MAX;
...
private:
    ...
    struct Entry
    {
        std::string name, filePath, entryPoint;
    ...
    void compileEntry(Entry& e, const std::string& source);
    void reflectEntry(Entry& e);
    void destroyModule(Entry& e);
};
} // namespace Renderer
} // namespace Engine
